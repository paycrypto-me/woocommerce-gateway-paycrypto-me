...
final class WC_Gateway_PayCryptoMe_Blocks extends AbstractPaymentMethodType
{
    ...
    public function get_payment_method_data()
    {
        if (!$this->gateway) {
            return [
                'title' => 'PayCrypto.Me',
                'description' => __('Use directly your Bitcoin wallet to pay. Place the order to view the QR code and payment instructions.', 'woocommerce-gateway-paycrypto-me'),
                'debug_log' => 'no',
                'supports' => ['products']
            ];
        }
        ...
        return [
            ...
            'description' => $this->gateway->description ?: __('Use directly your Bitcoin wallet to pay. Place the order to view the QR code and payment instructions.', 'woocommerce-gateway-paycrypto-me'),
